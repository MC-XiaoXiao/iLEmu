...
inline constexpr std::uint32_t media_type_ieee80211 = 0x00000080U;
...
namespace apple80211_driver {
    ...
    inline constexpr std::uint32_t association_header_size = 54;
    inline constexpr std::uint32_t event_association_completed = 9;
