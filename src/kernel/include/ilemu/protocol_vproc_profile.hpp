...
inline constexpr Profile without_service_policy{
    "without-service-policy",
    xnu792::mig::protocol_vproc::id(
        xnu792::mig::protocol_vproc::Routine::swap_integer) +
        1U};
inline constexpr Profile with_service_policy{
    "with-service-policy",
    xnu792::mig::protocol_vproc::id(
...
[[nodiscard]] constexpr const Profile *
profile_for_log_message(std::uint32_t message_id) {
