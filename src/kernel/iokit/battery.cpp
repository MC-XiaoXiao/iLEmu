...
std::uint32_t ensure_service_locked(KernelSharedState &state) {
  ...
  properties.emplace("Current Capacity",
                     number_property(default_capacity_percent));
  properties.emplace("Max Capacity", number_property(default_capacity_percent));
  ...
  properties.emplace("CurrentCapacity",
                     number_property(default_capacity_percent));
  properties.emplace("MaxCapacity", number_property(default_capacity_percent));
  ...
  state.iokit_services.emplace(object, KernelSharedState::IOKitService{
