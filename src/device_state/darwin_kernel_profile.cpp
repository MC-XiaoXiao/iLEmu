...
namespace {
    ...
    constexpr std::array build_profile_rules {
        ...
        build_family_rule("5A", DarwinAbiEpoch::IphoneOs2,
            DarwinPthreadAbiProfile::LegacyMachThreads, { true, false, false }),
        build_family_rule("5G", DarwinAbiEpoch::IphoneOs2,
            DarwinPthreadAbiProfile::LegacyMachThreads, { true, false, false }),
        build_family_rule("7A", DarwinAbiEpoch::IphoneOs3,
            DarwinPthreadAbiProfile::LegacyMachThreads, { true, false, false }),
        BuildProfileRule { "7B", BuildMatchKind::FamilyPrefix,
    ...
    [[nodiscard]] bool matches_build(
        const BuildProfileRule& rule, std::string_view build)
    {
...
DarwinKernelIdentityProfile make_darwin_kernel_identity_profile(
